---
name: patronus-setup
description: Set up or diagnose Patronus CLI authentication, processing mode, local models and the global deepseek plugin when the user requests installation or setup.
---
