...
For updates use `patronus-security-scanner maintenance update` and `patronus-security-scanner integration codex update`. Public release installation requires the release artifacts to have been published. Use the CLI help for explicit source overrides during development.
