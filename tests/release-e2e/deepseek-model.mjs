...
export function apply(ctx, config) {
  ...
  class ScriptedModel extends LlmAdapter {
    ...
    async *stream(options) {
      ...
      writeFileSync(config.evidence, JSON.stringify({ ...(config.flow === 'read-redacted' ? { exactRedaction: true, unchangedSurroundingContent: true } : {}), states, tools, sourceExecutions: reads, modelCalls: calls, completed: true }))
