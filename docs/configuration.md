...
| `request_timeout_ms` | Request job deadline; 1 through `scan_timeout_ms`. Completed findings stop the turn; infrastructure failure or timeout continues with degraded context. |
